	...
	<div class="content">
		<div class="content-chats">
			...
			<div class="sub-content-chats">
				<a href="chat.php"><button class="chat-on">Lavado de dinero</button></a>
				<a href="chat1.php"><button class="chat-off">Otro curso</button></a>
				<a href="chat2.php"><button class="chat-off">Otro curso</button></a>
			</div>

				<div class="sub-content-chat">
					<div class="content-chat-top">
						<div class="content-title-chat">Lavado de dinero</div>
					</div>
					<div class="content-chat">
						<div class="content-mess">
							<?php 
								...
								$sqlA = $mysqli->query("SELECT * FROM ald ORDER BY id ASC");
					...
					<div class="content-send">
						...
						<?php
							...
							$ultpub = $mysqli->query("SELECT id FROM data WHERE id = '".$_SESSION['id']."'");
          					...
          					$query = "INSERT INTO ald (user,message,date) VALUES ('".$ultp['id']."','".$mensaje."',now())";

       						$mysqli->query($query); 

       						if($query) {header("refresh: 0; url = chat.php");}
							}
