	...
	<div class="content">
		<div class="content-chats">
			...
			<div class="sub-content-chats">
				...
				<a href="chat1.php"><button class="chat-on">Otro curso</button></a>
					...
					<div class="content-chat">
						<div class="content-mess">
							<?php 
								...
								$sqlA = $mysqli->query("SELECT * FROM otro ORDER BY id ASC");
					...
					<div class="content-send">
						...
						<?php
							...
							$ultpub = $mysqli->query("SELECT id FROM data WHERE id = '".$_SESSION['id']."'");
          					...
          					$query = "INSERT INTO otro (user,message,date) VALUES ('".$ultp['id']."','".$mensaje."',now())";

       						$mysqli->query($query); 

       						if($query) {header("refresh: 0; url = chat1.php");}
							}
